...
/**
 * Interim-message text shown while the chat session is being established.
 * Exported so the UI can detect the "waiting to connect" phase (e.g. to hide the
 * input until the session is ready).
 */
export const CONNECTING_INTERIM_MESSAGE = "Connecting...";

const copy = {
  thinking: "Thinking...",
  typing: "Typing...",
  connecting: CONNECTING_INTERIM_MESSAGE,
