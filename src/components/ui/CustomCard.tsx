 ...
 * @example
 * ```tsx
 * import { CustomCard, CustomCardImageRow, CustomCardRow, React } from '@amazon-connect-touchpoint/web';
 *
 * const MyCard = ({data}) => (
 ...
 * @example
 * ```tsx
 * import { CustomCardRow, Icons, BaseText, React } from '@amazon-connect-touchpoint/web';
 *
 * const MyCardRow = () => (
 *   <CustomCardRow
